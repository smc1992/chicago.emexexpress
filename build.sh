...
# Chicago Airfreight Landing Page Docker Build Script
...
IMAGE_NAME="chicago-airfreight-landing"
VERSION=${1:-latest}

echo "🇺🇸 Building Chicago Airfreight Landing Page Docker Image"
...
echo ""
echo "🎯 Chicago Docker image ready for Coolify deployment!"
echo "📍 Image: $DOCKER_REGISTRY/$IMAGE_NAME:$VERSION"
echo "🌐 Domain: chicago.emexexpress.de"
echo ""
